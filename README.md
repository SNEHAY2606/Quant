...
Clone the project repository and navigate to the project directory: bash git clone https://github.com/NawadhaJadiya/Quant cd Quant
...
Clone the repository: bash git clone https://github.com/NawadhaJadiya/Quant

Create a Virtual Environment to manage dependencies: bash python -m venv env

Activate the virtual environment:

On Windows: bash source env/Scripts/activate

On Mac/Linux: bash source env/bin/activate

Fork the repository.

Create a feature branch: bash git checkout -b feature-name

Commit your changes: bash git commit -m 'Add feature'

Push the branch: bash git push origin feature-name
